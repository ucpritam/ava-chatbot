...
def run(item):
          ...
          for i in text1:
                    vector1 = text_to_vector(i.lower())
                    ...
                    if cosine >= 0.70:
                              ...
                              bot.train("chatterbot.corpus.formals")
                              robo_response =   bot.get_response(item)
                              break
                    else:
                              robo_response = "Sorry I am not able to understand it, Can you rephrase it and try !!"
